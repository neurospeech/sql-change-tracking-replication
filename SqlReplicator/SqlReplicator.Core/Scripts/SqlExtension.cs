...
namespace SqlReplicator.Core
{
	public partial class Scripts{
				...
				public static string UpdateRST = "UPDATE CT_REPLICATIONSTATE SET 	EndSync = GETUTCDATE(), 	LastSyncResult = ISNULL(@LastSyncResult,LastSyncResult), 	LastFullSync = ISNULL(@LastFullSync,LastFullSync), 	LastVersion = @LastVersion WHERE  	TableName = @TableName";
